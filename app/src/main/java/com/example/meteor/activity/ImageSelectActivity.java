...
import com.example.meteor.action.StatusAction;
import com.example.meteor.adapter.ImageSelectAdapter;
import com.example.meteor.aop.Log;
import com.example.meteor.aop.Permissions;
import com.example.meteor.aop.SingleClick;
import com.example.meteor.app.AppActivity;
import com.example.meteor.dialog.AlbumDialog;
import com.example.meteor.manager.ThreadPoolManager;
import com.example.meteor.ui.StatusLayout;
import com.example.meteor.util.GridSpaceDecoration;
    ...
    protected void onRestart() {
        ...
        while (iterator.hasNext()) {
            ...
            if (mSelectImage.isEmpty()) {
                ...
                mFloatingView.setImageResource(R.drawable.tips_finish_ic);
            }
        }
    }
